...
describe('page', function () {
    ...
    test('can be accessed by admin', function () {
    ...
    test('cannot be access by guest, who is redirected to login', function () {
        Teacher::factory(random_int(1, 10))->create();
...
describe('table', function () {
    test('displays correct values for a given teacher', function () {
    ...
    describe('columns', function () {
        ...
        test("default sorting is by 'name' in ascending order", function () {
        ...
        describe("'name'", function () {
            ...
            test('is visible initially', function () {
                livewire(ListTeachers::class)
                    ->assertCanRenderTableColumn('name');
            });
        });

        describe("'isExpiringToday", function () {
            test('is visible initially', function () {
                livewire(ListTeachers::class)
        ...
        describe("'isNearAuthorisationExpiry", function () {
            test('is visible initially', function () {
                livewire(ListTeachers::class)
        ...
        describe("'currentAuthorisationStatus.value'", function () {
            test('is searchable', function () {
        ...
        describe("'firstAuthorisationCohort.name'", function () {
            test('is searchable', function () {
        ...
        describe("'latestUpdateCohort.name'", function () {
            test('is searchable', function () {
        ...
        describe("'teaches_at_cvi'", function () {
            test('is sortable', function () {
        ...
        describe("'territoryOfResidence.english_name'", function () {
            test('is searchable', function () {
                $territories = Territory::inRandomOrder()
                    ->limit(10)
                    ->get();
        ...
        describe("'territoryOfOrigin.english_name'", function () {
            test('is searchable', function () {
                $territories = Territory::inRandomOrder()
                    ->limit(10)
                    ->get();
        ...
        describe("'qualification_string'", function () {
            test('is searchable', function () {
                Teacher::factory()->create([
        ...
        describe("'business_email'", function () {
            test('is searchable', function () {
                Teacher::factory(random_int(5, 10))->create();
        ...
        describe("'business_phone'", function () {
            test('is searchable', function () {
        ...
        describe("'business_website'", function () {
            test('is searchable', function () {
        ...
        describe("'gives_video_lessons'", function () {
            test('is sortable', function () {
        ...
        describe("'profile_image_path'", function () {
            test('is visible initially', function () {
                livewire(ListTeachers::class)
        ...
        describe("'created_at'", function () {
            ...
            test('is hidden initially', function () {
                livewire(ListTeachers::class)
